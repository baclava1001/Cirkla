...
{
    /// <inheritdoc />
    public partial class NewInitialWithFKeys : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CircleAdministrators", x => new { x.CircleId, x.UserId });
                    table.ForeignKey(
                        name: "FK_CircleAdministrators_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CircleJoinRequests_AspNetUsers_FromUserId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CircleJoinRequests_AspNetUsers_UpdatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContractStatusChanges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContractStatusChanges_AspNetUsers_ChangedById",
                        column: x => x.ChangedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ContractStatusChanges_Contracts_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contracts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CircleAdministrators_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CircleJoinRequests_FromUserId",
                table: "CircleJoinRequests",
                column: "FromUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContractStatusChanges_ChangedById",
                table: "ContractStatusChanges",
                column: "ChangedById");

            migrationBuilder.CreateIndex(
                name: "IX_ContractStatusChanges_ContractId",
                table: "ContractStatusChanges",
                column: "ContractId");
